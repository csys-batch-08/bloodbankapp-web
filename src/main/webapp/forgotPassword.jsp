			...
			<form action="Forgotpassword" method="post">
				...
				<div class="formcontrol">
					<label for="number" class="d-none"></label> <input type="text"
						...
						placeholder="Enter the PhoneNumber" title=" mininum 10characters" /><br />
					<br />
				</div>
				<div class="formcontrol">
				...
				<div class="formcontrol">
					<label for="CONFIRM" class="d-none"></label> <input type="password"
				...
				<div class="formbtn">
					<input type="submit" value="submit" /> <label for="reset"
						class="d-none"></label> <input type="reset" id="reset"
						value="reset" />
				</div>
