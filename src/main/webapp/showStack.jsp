...
<link rel="stylesheet" type="text/css" href="assets/css/tableandsubmit.css">
</head>
			...
			<div class="content">
				<form action="BloodPriceChangeServlet" method="post"
					style="text-align: center;">
						...
						<input list="blood type" id="bloodType" name="bloodtype" required="required" autofocus="autofocus"
					...
					<datalist id="blood type">
						...
						name="Price" required="required" pattern="[1-9][0-9]+" title="plese enter the valid number">
